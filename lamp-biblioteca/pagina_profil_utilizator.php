...
$sql_istoric = "
    SELECT 
        C.TitluCarte, 
        AC.DataActiune AS DataReturnare -- Data la care a avut loc actiunea de returnare (StatusCarteActiune = 'Returnată')
    FROM ACTIUNE AC
    JOIN CARTE C ON AC.IDcarte = C.IDcarte
    WHERE AC.IDmembru = ? 
      AND AC.TipActiune = 'Împrumut' 
...
<body>
	...
	<nav>
		<ul>
			<li><a href="pagina_acasa.html">Acasă</a></li>
			<li><a href="#profil">Profilul Meu</a></li>
			<li><a href="#imprumuturi">Cărți Împrumutate</a></li>
			<li><a href="#istoric">Istoric</a></li>
			<li><a href="#setari">Setări Cont</a></li>
			<li><a href="profil.php?action=logout" class="link-button" style="background-color: #dc3545; padding: 5px 10px;">Delogare</a></li>
		</ul>
	</nav>
